...
function runTests() {
  ...
  test('Template version label is v2.0.7', function () {
    var tpl = readFile(TEMPLATE);
    assert(tpl.indexOf('v2.0.7') !== -1, 'Version label should be v2.0.7');
  });
  ...
  test('constants.js defines APP', function () {
    ...
    assert(src.indexOf("VERSION: '2.0.7'") !== -1, 'APP.VERSION should be 2.0.7');
  });
